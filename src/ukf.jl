...
function measurement_update(𝐱_init, 𝐏_init, 𝐱_prev, 𝐏_prev, χ, 𝐱, 𝐏, iweights, weights, 𝐲, h::Function, used_states, reset_unused_states)
    ...
    (𝐓, 𝐐, 𝐑, used_states::BitArray{1} = trues(length(𝐱))) -> 
        time_update(𝐱_init, 𝐏_init, 𝐱_next, 𝐏_next, weights, 𝐓, 𝐐, 𝐑, used_states, reset_unused_states), part_𝐱_next, part_𝐏_next, 𝐲̂, 𝐏yy
end

function measurement_update(𝐱_init, 𝐏_init, 𝐱_prev, 𝐏_prev, χ, 𝐱, 𝐏, iweights, weights, 𝐲, h::Function, 𝐑, used_states, reset_unused_states)
    part_𝐱_next, part_𝐏_next, 𝐲̂, 𝐏yy = _measurement_update(χ, 𝐱, 𝐏, iweights, 𝐲, h, 𝐑)
    𝐱_next, 𝐏_next = expand_states(part_𝐱_next, part_𝐏_next, 𝐱_init, 𝐏_init, 𝐱_prev, 𝐏_prev, used_states, reset_unused_states)
    (𝐓, 𝐐, used_states::BitArray{1} = trues(length(𝐱))) -> 
        time_update(𝐱_init, 𝐏_init, 𝐱_next, 𝐏_next, weights, 𝐓, 𝐐, used_states, reset_unused_states), part_𝐱_next, part_𝐏_next, 𝐲̂, 𝐏yy
end

function measurement_update(𝐱_init, 𝐏_init, 𝐱_prev, 𝐏_prev, 𝐱, 𝐏, iweights, weights, 𝐲, h::Function, used_states, reset_unused_states)
    χ = calc_sigma_points(𝐱, 𝐏, iweights)
    part_𝐱_next, part_𝐏_next, 𝐲̂, 𝐏yy = _measurement_update(χ, 𝐱, 𝐏, iweights, 𝐲, h, 0)
    𝐱_next, 𝐏_next = expand_states(part_𝐱_next, part_𝐏_next, 𝐱_init, 𝐏_init, 𝐱_prev, 𝐏_prev, used_states, reset_unused_states)
    (𝐓, 𝐐, 𝐑, used_states::BitArray{1} = trues(length(𝐱))) -> 
...
function measurement_update(𝐱_init, 𝐏_init, 𝐱_prev, 𝐏_prev, 𝐱, 𝐏, iweights, weights, 𝐲, h::Function, 𝐑, used_states, reset_unused_states)
    χ = calc_sigma_points(𝐱, 𝐏, iweights)
    part_𝐱_next, part_𝐏_next, 𝐲̂, 𝐏yy = _measurement_update(χ, 𝐱, 𝐏, iweights, 𝐲, h::Function, 𝐑)
    𝐱_next, 𝐏_next = expand_states(part_𝐱_next, part_𝐏_next, 𝐱_init, 𝐏_init, 𝐱_prev, 𝐏_prev, used_states, reset_unused_states)
    (𝐓, 𝐐, used_states::BitArray{1} = trues(length(𝐱))) -> 
        time_update(𝐱_init, 𝐏_init, 𝐱_next, 𝐏_next, weights, 𝐓, 𝐐, used_states, reset_unused_states), part_𝐱_next, part_𝐏_next, 𝐲̂, 𝐏yy
end

function measurement_update(𝐱_init, 𝐏_init, 𝐱_prev, 𝐏_prev, 𝐱, 𝐏, iweights, weights, 𝐲, h::Function, 𝐑::Augment, used_states, reset_unused_states)
    𝐱ᵃ, 𝐏ᵃ = augment(𝐱, 𝐏, 𝐑)
